// models/Index.ts - COMPLETELY FIXED WITH PROPER ERROR HANDLING
...
// Helper function to safely create indexes without throwing duplicate errors
async function safeCreateIndex(
  ...
  try {
    ...
    // 86 = IndexKeySpecsConflict (index already exists)
    // 85 = IndexOptionsConflict (index exists with different options)
