...
class EmailService {
              ...
              <div class="content">
                  ...
                  <div class="details-box">
                      ...
                      <div class="detail-row">
                          ...
                          <span class="detail-value">${user.username || user.email}</span>
                      </div>
                      <div class="detail-row">
  ...
  // ==================== APPLICATION APPROVAL EMAIL (NO ACCOUNT CREATED YET) ====================
  ...
  async sendApplicationApproved(application: any, plan: any): Promise<void> {
    ...
    const adminHtml = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
          ...
          <hr>
          <p><strong>Next Step:</strong> Once the customer registers, go to the Billing page and click "Start Billing" to generate their first invoice.</p>
      </div>
    `;
    await this.sendToAdmin(
  ...
  // ==================== CREDENTIALS EMAIL (When admin starts billing) ====================
      ...
      <body>
          <div class="container">
              ...
              <div class="content">
                  ...
                  <p>Your first invoice has been sent to this email address. Please check your inbox for the invoice details.</p>
              </div>
