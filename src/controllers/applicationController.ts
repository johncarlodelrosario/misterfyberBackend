...
export const submitApplication = async (
  ...
  try {
    ...
    // FIX: Handle tower properly - it's optional, default to empty string
    ...
    // Check for existing application by phone
    ...
    // Create application - applicationId will be auto-generated by pre-save hook
